    ...
    return (
        <div className="card">
            <a onClick={handleButtonClick}><img src={process.env.PUBLIC_URL + '/images/posh.jpg'}
                                                 alt="Service 1"/></a>
            <h3>Даріна</h3>
            <p>Маркус просто найкращий! Я працюю з цією людиною вже дуже давно і вдячна йому за все! Ця людина реально зацікавлена у вашому успіху. Співпрацюйте - не пошкодуєте.</p>
        </div>
