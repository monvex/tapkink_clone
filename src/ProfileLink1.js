...
const ProfileButton1 = () => {
    ...
    const handleButtonClick = async () => {
        ...
        try {
            ...
            const response = await fetch('https://marcuspro.life/api/get-profile-link1');
    ...
    return (
        <div className="card">
            <a onClick={handleButtonClick}><img src={process.env.PUBLIC_URL + '/images/leha.jpg'}
                                                  alt="Service 1"/></a>
            <h3>Олексій</h3>
            <p>Хочу подякувати Маркусу за дуже чіткі інструкції та РЕАЛЬНО робочі методи заробітку в інтернеті!<br/>Однозначно рекомендую!</p>
